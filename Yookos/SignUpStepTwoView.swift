...
//        scroller?.addConstraint(specsScrollViewConstY);
        ...
        lblCountCode.layer.borderColor = Color.init().viewBorderColor().CGColor
        lblCountCode.layer.borderWidth = 1.0
        lblConfirmCode.layer.borderColor = Color.init().viewBorderColor().CGColor
        lblConfirmCode.layer.borderWidth = 1.0
        
        txtNumber.layer.borderColor = Color.init().viewBorderColor().CGColor
        txtNumber.layer.borderWidth = 1.0
        txtConfirmNum.layer.borderColor = Color.init().viewBorderColor().CGColor
